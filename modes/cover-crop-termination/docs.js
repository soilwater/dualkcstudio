...
/**
 * modes/cover-crop-termination/docs.js — documentation for the Cover Crop
...
<ol>
  ...
  <li><strong>Scenarios to compare</strong> — up to three termination dates,
      ...
      planting date.</li>
  <li><strong>Fallow after termination</strong> — the residue cover and curve
      number for the gap between termination and cash planting (and for the
      baseline's full fallow window).</li>

...
/**
 * modes/cover-crop-termination/index.js — Cover Crop Termination Timing on
...
function create() {
  ...
  const residueIn = numInput({ value: 100, min: 0, max: 100, step: 5, onChange: () => syncHints() });
  ...
  gFallow.body.append(ctrl('Residue cover', residueIn.el, { unit: '%' }), ctrl('Curve number', cnIn.el));

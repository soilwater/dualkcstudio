...
/**
 * modes/soil-limits/docs.js — documentation for the Soil Water Limits lookup.
 */
...
<table>
  ...
  <tr><td>Saxton &amp; Rawls 2006</td><td>Pedotransfer regressions at the class
      centroid texture (2% organic matter). WP = θ(−1500 kPa),
      FC = θ(−33 kPa).</td></tr>
  <tr><td>Scott et al. 2013</td><td>van Genuchten retention, Oklahoma Mesonet
      class averages. WP = θ(−1500 kPa), FC = θ(−33 kPa) and θ(−10 kPa).
      No sand/silt.</td></tr>
  ...
  <tr><td>Rosetta class average</td><td>van Genuchten retention, national
      Rosetta averages (Schaap et al. 2001). All 12 classes. WP = θ(−1500 kPa),
      FC = θ(−33 kPa) and θ(−10 kPa).</td></tr>
  <tr><td>Unit gradient 1 mm/day</td><td>Field capacity where unit-gradient
      drainage K(θ) = 1 mm/day (van Genuchten-Mualem, Rosetta parameters) —
      a drainage-based alternative. WP = θ(−1500 kPa).</td></tr>
</table>

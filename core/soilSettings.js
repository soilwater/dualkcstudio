 ...
 *               itself from fc/wp/Ze/REW_frac. The presets are set so REW
 *               lands inside FAO-56 Table 19's range for the texture
 *               (about 5 mm for sand, 8-10 mm for the loams and clay);
 *               engine.js caps REW at the table's 12 mm maximum
...
export const SOILS = {
  clay: {
    ...
    Ze: 0.10, REW_frac: 0.32, Zr_profile: 1.8,
  },
  siltyClayLoam: {
    label: 'Silty Clay Loam',
    fc: 0.38, wp: 0.19, ini: 0.30,
    Ze: 0.10, REW_frac: 0.33, Zr_profile: 1.8,
  },
  siltLoam: {
    label: 'Silt Loam',
    fc: 0.33, wp: 0.13, ini: 0.26,
    Ze: 0.12, REW_frac: 0.30, Zr_profile: 1.8,
  },
  clayLoam: {
    label: 'Clay Loam',
    fc: 0.36, wp: 0.18, ini: 0.29,
    Ze: 0.10, REW_frac: 0.35, Zr_profile: 1.8,
  },
  loam: {
    label: 'Loam',
  ...
  sandyLoam: {
    ...
    Ze: 0.15, REW_frac: 0.30, Zr_profile: 1.8,
  },
  sand: {
    label: 'Sand',
    fc: 0.12, wp: 0.04, ini: 0.10,
    Ze: 0.15, REW_frac: 0.33, Zr_profile: 1.8,
  },
  custom: {
    label: 'Custom',
    fc: 0.31, wp: 0.12, ini: 0.25,

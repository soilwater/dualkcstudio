...
/**
 * tools/rotation/blocks.js — pure rotation logic: the block model (crop /
...
export function makeFallowBlock(overrides = {}) {
  return {
    ...
    p_tab: FALLOW_PRESET.p_tab, residue_pct: 50, CN: FALLOW_PRESET.CN,
    ...overrides,
  };
}
...
export function makeAlfalfaBlock(overrides = {}) {
  return {
    ...
    p_tab: ALFALFA_PRESET.p_tab, residue_pct: 50, CN: ALFALFA_PRESET.CN,

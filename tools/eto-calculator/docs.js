...
/**
 * tools/eto-calculator/docs.js — documentation for the ETo Calculator mode.
 */
...
weather CSV and hands the file back with one <code class="var">eto</code> column
...
<ol>
  ...
  <li><strong>Site</strong> — latitude and elevation. Latitude (north positive,
      ...
      <code>latitude</code>/<code>elevation</code> columns in your file if present.</li>
  ...
  <li><strong>Compute</strong>, review the plot, then <strong>Download
      CSV</strong> — your original file, unchanged, with <code class="var">eto</code>
...
required input gets a blank <code class="var">eto</code>. The downloaded file keeps your
original values as-is; only the <code class="var">eto</code> column is added.</p>

...
/**
 * tools/home.js — landing view: what the app is, and the mode cards.
 */
...
const glyph = {
  ...
  /* A cloud with a download arrow: pull weather data into a file. */
  openmeteo: `<svg viewBox="0 0 120 56" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <g fill="#9ec5f4">
      <circle cx="44" cy="26" r="10"/>
      <circle cx="58" cy="21" r="13"/>
      <circle cx="71" cy="27" r="9"/>
      <rect x="44" y="24" width="27" height="12" rx="2"/>
    </g>
    <g fill="none" stroke="#1baf7a" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
      <line x1="58" y1="34" x2="58" y2="49"/>
...
/* One uniform grid. `cat` shows as a subtle pill on each card for a hint of
   what it does; the Data & Inputs tools are kept together at the end. */
const CARDS = [
  {
    href: '#/single-season', glyph: glyph.season, name: 'Single Season', cat: 'Time series',
  ...
  {
    href: '#/probabilistic', glyph: glyph.prob, name: 'Probabilistic & Scenario', cat: 'Time series',
  ...
  {
    href: '#/rotation', glyph: glyph.rot, name: 'Crop Rotation', cat: 'Time series',
  ...
  {
    href: '#/cover-crop-termination', glyph: glyph.termination, name: 'Cover Crop Termination', cat: 'Time series',
  ...
  {
    href: '#/field-scale', glyph: glyph.field, name: 'Field Scale', cat: 'Spatial',
  ...
  {
    href: '#/mesoscale', glyph: glyph.spatial, name: 'Mesoscale', cat: 'Spatial',
  ...
  {
    href: '#/eto-calculator', glyph: glyph.eto, name: 'ETo Calculator', cat: 'Data & Inputs',
  ...
  {
    href: '#/soil-limits', glyph: glyph.soil, name: 'Soil Water Limits', cat: 'Data & Inputs',
  ...
  {
    href: '#/gee-collector', glyph: glyph.gee, name: 'GEE Data Collector', cat: 'Data & Inputs',
    ...
    el('div', { class: 'doc-inner' },
      el('div', { style: { maxWidth: '46rem' } },
        ...
        el('p', { style: { color: 'var(--ink-2)', marginTop: '0.6rem' } },
          'Every tool below feeds or runs the same tested water-balance engine — strict FAO-56 by default, with optional documented refinements. Data stays in your browser; nothing is uploaded.'),
      ),
      el('div', { class: 'mode-cards' }, CARDS.map(card)),
